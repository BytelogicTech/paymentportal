...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 15, 2022 at 07:52 AM
...
CREATE TABLE `customer_documents` (
  ...
  `parent_merchant` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(15, '2022_03_13_145534_create_customers_table', 7),
(16, '2022_03_13_154645_create_bank_account_payouts_table', 7),
(17, '2022_03_14_081522_create_customer_documents_table', 8);
