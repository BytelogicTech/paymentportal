                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" placeholder="Enter Phone" class="form-control" name="phone" required />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" placeholder="Select Date of Birth" class="form-control" name="secondary_email" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="description">ID Number</label>
                                            <input type="email" placeholder="Enter ID Number" class="form-control" name="id_number" required />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Enter Beneficiary Name" class="form-control" name="first_name" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="description">Beneficiary Nickname</label>
                                            <input type="text" placeholder="Enter Beneficiary Nick Name" class="form-control" name="last_name" required />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Enter Bank Name" class="form-control" name="first_name" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="description">Bank Branch</label>
                                            <input type="text" placeholder="Enter Bank Branch" class="form-control" name="last_name" required />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Bank Address" class="form-control" name="first_name" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Enter Bank SWIFT" class="form-control" name="first_name" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="description">Account Number/IBAN *</label>
                                            <input type="text" placeholder="Enter Account Number" class="form-control" name="last_name" required />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Remarks/ABA Code/Sort Code/Routing Number/IFSc Code" class="form-control" name="last_name" required />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Enter Intermediary Bank Name" class="form-control" name="secondary_email" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="description">Intermediary Bank Address (Optional)</label>
                                            <input type="text" placeholder="Enter Intermediary Bank Address" class="form-control" name="id_number" required />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Enter Intermediary Bank SWIFT" class="form-control" name="secondary_email" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="description">Intermediary Bank Details Remarks (Optional)</label>
                                            <input type="text" placeholder="Enter Remark" class="form-control" name="id_number" required />
                                        </div>
                                    </div>
                                </div>
