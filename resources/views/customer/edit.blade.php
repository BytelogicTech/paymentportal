...
<div class="content-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea placeholder="Address" class="form-control" name="address" value="{{$customer->address}}"></textarea>
 ...
 @foreach($customerdocuments as $customerdocument)
        ...
        @endforeach          
                                ...
                                <center>
                                    <p>Status</p>
                                    <input type="checkbox" data-toggle="switch" data-handle-width="100" data-on-text="Activated" data-off-text="Deactivated" name="status" value="{{$customer->status}}" >
