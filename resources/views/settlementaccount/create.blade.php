            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">SettlementAccount</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="{{url('settlementaccount/store')}}" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                @csrf
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Enter Beneficiary Nickname" class="form-control" name="beneficiary_nickname"  />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Enter Bank Address" class="form-control" name="bank_address"  />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Country</label>
                                            <select class="select2 form-control" name="bank_country">
                                ...
                                <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Enter Bank SWIFT" class="form-control" name="bank_swift"  />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Enter Remarks" class="form-control" name="intermediary_bank_details_remarks"/>
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card -->
<hr>
                                ...
                                <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" name="upload_bank_statement" required>
                                        </div>
                                    </div>
